## Purpose
Defines the auto-incrementing semver versioning system. Version is derived from a `VERSION` file (major.minor) plus auto-counted git tags for patch. Version is injected into build artifacts at CI time. Production builds auto-create version tags.
