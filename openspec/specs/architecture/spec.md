...
#### Scenario: User lists available tmux sessions
- **WHEN** the mobile app requests GET /api/sessions
- **THEN** the daemon returns a JSON list of all tmux sessions with their ID, working directory, Claude Code status, and window count
